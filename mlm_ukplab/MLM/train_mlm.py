...
# Load the model
model = AutoModelForMaskedLM.from_pretrained(checkpointModel_folder if checkpointModel_folder != None else model_name)
tokenizer = AutoTokenizer.from_pretrained(checkpointModel_folder if checkpointModel_folder != None else model_name)
